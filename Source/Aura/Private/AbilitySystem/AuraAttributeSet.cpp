...
void UAuraAttributeSet::HandleIncomingXP(const FEffectProperties& Props)
{
	...
	if (Props.SourceCharacter->Implements<UPlayerInterface>() && Props.SourceCharacter->Implements<UCombatInterface>())
	{
		...
		{
			//TODO:
			const int32 AttributePointsReward = IPlayerInterface::Execute_GetAttributeReward(Props.SourceCharacter, CurrentLevel);
			const int32 SpellPointsReward = IPlayerInterface::Execute_GetSpellReward(Props.SourceCharacter, CurrentLevel);
